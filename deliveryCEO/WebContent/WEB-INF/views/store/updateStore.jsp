			...
			<table class="table">
				...
				<tr>
					...
					<td style="text-align: left;">
						<input type="text" name="storeTel" id="storeTel" class="form-control"
							placeholder="ex) 02-1234-5678" value="<%=store.getStoreTel().trim()%>"
				...
				<tr>
					...
					<td style="text-align: left;">
						<input type="text" name="storeStartTime" id="storeStartTime" class="form-control"
							placeholder="ex) 09:00" value="<%=store.getStoreStartTime().trim()%>"
							style="width: 50%; display: inline-block;"> <span class="msg"
							style="margin-left: 10px;"></span>
					</td>
				</tr>
				<tr>
					...
					<td style="text-align: left;">
						<input type="text" name="storeEndTime" id="storeEndTime" class="form-control"
							placeholder="ex) 23:00" value="<%=store.getStoreEndTime().trim()%>"
							style="width: 50%; display: inline-block;"> <span class="msg"
							style="margin-left: 10px;"></span>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						...
						%>
						<input type="file" name="fileName" value="/filepath/01_store/<%=store.getStoreFilePath()%>"
				...
				<tr>
					...
					<td>
						<div style="text-align: left;">
							...
							%>
							<img id="img-view" width="350" src="/filepath/01_store/<%=store.getStoreFilePath()%>">
							<%
								}
							%>
						</div>
